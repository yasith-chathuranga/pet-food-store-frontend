...
export const CatFoodStore = () => {
    ...
    const openModalForEdit = (catFood: CatFood) => {
        setSelectedCatFood(catFood);
        setIsViewMode(false);
        setIsModalOpen(true);
    };

    const handleDelete = (catFood: CatFood) => {
        const confirmation = window.confirm(`Are you sure you want to delete ${catFood.name}?`);
        if (confirmation) {
            dispatch(deleteCatFood(catFood.id));
        }
    };
    useEffect(() => {
                    ...
                    <div className="container mx-auto px-8 py-8">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <AddButton onClick={openModalForAdd}>Add New Cat Food</AddButton>
                            </div>
                        </div>
