...
const Login: React.FC = () => {
    ...
    return (
        <div>
            <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-r from-blue-300 to-gray-100">
                <div className="flex flex-col md:flex-row w-full md:w-[1200px] md:h-[600px] max-w-6xl bg-white/20 backdrop-blur-lg backdrop-saturate-150 border border-white/20 rounded-3xl shadow-lg overflow-hidden">
                    <div
